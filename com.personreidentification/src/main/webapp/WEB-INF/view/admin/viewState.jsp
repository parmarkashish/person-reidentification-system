    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Manage State / View State</h6>
            ...
            <table id="datatable1" class="table-white display responsive nowrap">
              ...
              <tbody>
               <c:if test="${stateList ne null}">
								...
								<c:forEach items="${stateList}" var="r" varStatus="status">
									<tr>
										<td>${status.count}</td>
										<td>${r.stateName}</td>
										...
										<td><a href="/admin/editState?id=${r.id}">Edit</a> | <a
											href="/admin/deleteState?id=${r.id}">Delete</a></td>
									</tr>
