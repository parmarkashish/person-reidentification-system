	...
	<div class="am-mainpanel">
		<div class="am-pagebody">
			...
			<div class="card pd-20 pd-sm-40">
				<h6 class="card-body-title">Manage Country / Add Country</h6>
				<p class="mg-b-20 mg-sm-b-30"></p>

				<f:form action="/admin/addCountry"
						...
						<div class="d-md-block mg-b-30">
							<div class="form-group mg-b-0">
								...
								<f:input path="countryName"
									...
									placeholder="Enter country name" required="required"></f:input>
							</div>
							<!-- form-group -->
							<br />
							<div class="form-group mg-b-0 mg-t-20 mg-md-t-0">
								<label>Country Description:</label>
								<f:textarea path="countryDescription"
									class="form-control wd-200 wd-sm-1000"
									placeholder="Enter country description"></f:textarea>
							</div>
							<!-- form-group -->
