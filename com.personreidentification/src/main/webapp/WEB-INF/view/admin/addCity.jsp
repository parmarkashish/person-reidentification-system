	...
	<div class="am-mainpanel">
		<div class="am-pagebody">
			...
			<div class="card pd-20 pd-sm-40">
				<h6 class="card-body-title">Manage City / Add City</h6>
				<p class="mg-b-20 mg-sm-b-30"></p>

				<f:form action="/admin/addCity" data-parsley-validate="data-parsley-validate" modelAttribute="cityVO">
					<div class="wd-300">
						<div class="d-md-block mg-b-30">
							...
							<label>Country Name: <span class="tx-danger">*</span></label>
								<f:select class="form-control select2" path="countryVO.id"
									...
									data-parsley-errors-container="#slErrorContainer" required="required" onchange="fn()" id="country">
							...
							<label>State Name: <span class="tx-danger">*</span></label>
								<f:select class="form-control select2" path="stateVO.id"
									data-placeholder="Choose one"
									data-parsley-class-handler="#slWrapper"
									data-parsley-errors-container="#slErrorContainer" required="required" id="state">
							...
							<div class="form-group mg-b-0">
								<label>City Name: <span class="tx-danger">*</span></label> <f:input
									path="cityName"
									class="form-control wd-200 wd-sm-1000"
									placeholder="Enter city name" required="required"></f:input>
							</div>
							...
							<div class="form-group mg-b-0 mg-t-20 mg-md-t-0">
								<label>City Description: <span class="tx-danger">*</span></label>
								<f:textarea path="cityDescription"
									class="form-control wd-200 wd-sm-1000"
