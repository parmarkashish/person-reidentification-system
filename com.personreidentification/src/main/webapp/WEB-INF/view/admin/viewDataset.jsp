...
<html lang="en">
  ...
  <body>
    ...
    <!-- <div class="am-pagetitle">
      <h5 class="am-title">Manage Dataset</h5>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Manage Dataset / View Dataset</h6>
          ...
          <div class="table-wrapper">
            <table id="datatable1" class="table-white display responsive nowrap">
              <thead>
                <tr>
                  <th class="wd-10p">Dataset ID</th>
                  <th class="wd-15p">Name</th>
                  <th class="wd-20p">Description</th>
                  <th class="wd-20p">S3 link</th>
              ...
              <tbody>
							...
							<c:if test="${datasetList ne null}">

								<c:forEach items="${datasetList}" var="r" varStatus="status">
									<tr>
										<td>${status.count}</td>
										<td>${r.datasetName}</td>
										<td>${r.datasetDescription}</td>
										<td>${r.s3link}</td>
										<td><a href="/admin/editDataset?id=${r.id}">Edit</a> | <a
											href="/admin/deleteDataset?id=${r.id}">Delete</a></td>
									</tr>
