    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Manage Package / View Package</h6>
          ...
          <div class="table-wrapper">
            <table id="datatable1" class="table-white display responsive nowrap">
              ...
              <tbody>
               <c:if test="${packageList ne null}">

								<c:forEach items="${packageList}" var="r" varStatus="status">
									<tr>
										<td>${status.count}</td>
										<td>${r.packageName}</td>
										<td>${r.packagePrice}</td>
										<td>${r.packageDuration}</td>
										<td>${r.packageDescription}</td>
										
										<td><a href="/admin/editPackage?id=${r.id}">Edit</a> | <a
											href="/admin/deletePackage?id=${r.id}">Delete</a></td>
									</tr>
