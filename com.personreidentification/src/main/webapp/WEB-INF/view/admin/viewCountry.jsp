    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Manage Country / View Country</h6>
                  ...
                  <th class="wd-20p">Action</th>
						...
						<tbody>
							...
							<c:if test="${countryList ne null}">
								...
								<c:forEach items="${countryList}" var="r" varStatus="status">
									<tr>
										<td>${status.count}</td>
										<td>${r.countryName}</td>
										<td>${r.countryDescription}</td>
										
										<td><a href="/admin/editCountry?id=${r.id}">Edit</a> | <a
											href="/admin/deleteCountry?id=${r.id}">Delete</a></td>
									</tr>
