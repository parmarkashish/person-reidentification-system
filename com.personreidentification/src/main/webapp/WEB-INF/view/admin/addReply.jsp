	...
	<div class="am-mainpanel">
		<div class="am-pagebody">
			...
			<div class="card pd-20 pd-sm-40">
				<h6 class="card-body-title">View Complain / Add Reply</h6>
				<p class="mg-b-20 mg-sm-b-30"></p>

				<f:form action="/admin/addReply"
					data-parsley-validate="data-parsley-validate"
					modelAttribute="complainVO">
					<div class="wd-300">
						<f:hidden path="id" />
						...
						<div class="d-md-block mg-b-30">
							<div class="form-group mg-b-0">
								...
								<f:input path="complainSubject"
									...
									required="required" readonly="true" style="background-color:#ddd"></f:input>
							</div>
							<!-- form-group -->
							<br />
							<div class="form-group mg-b-0 mg-t-20 mg-md-t-0">
								...
								<f:textarea path="complainDescription"
									class="form-control wd-200 wd-sm-1000"
									 readonly="true" style="background-color:#ddd"></f:textarea>
							</div>
							<!-- form-group -->
							<br />
							<div class="form-group mg-b-0 mg-t-20 mg-md-t-0">
								<label>Reply: </label>
								<f:textarea path="reply"
									class="form-control wd-200 wd-sm-1000"
									placeholder="type your reply"></f:textarea>
							</div>
