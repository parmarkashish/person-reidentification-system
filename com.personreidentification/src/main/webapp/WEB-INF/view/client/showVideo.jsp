    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Manage Video / Show Video</h6>
          <p class="mg-b-20 mg-sm-b-30"></p>
          <video width="320" height="240" controls autoplay loop>
          <source src="${videoVO.getInputLink()}" type="video/mp4" />
         <source src="${videoVO.getOutputLink()}" type="video/webm" />
          </video>
          <%-- <video src="${videoVO.getInputLink()}" controls></video>
          <video src="${videoVO.getOutputLink()}" controls></video> --%>
           ${videoVO.getInputLink()}
           ${videoVO.getOutputLink()}
        </div><!-- card -->
