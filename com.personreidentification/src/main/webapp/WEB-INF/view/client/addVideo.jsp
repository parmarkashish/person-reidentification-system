	...
	<div class="am-mainpanel">
		<div class="am-pagebody">
			...
			<div class="card pd-20 pd-sm-40">
				<h6 class="card-body-title">Manage Video / Add Video</h6>
				<p class="mg-b-20 mg-sm-b-30"></p>

				<form action="/client/addVideo"
					data-parsley-validate="data-parsley-validate"
					enctype="multipart/form-data" method="post">
					<div class="wd-300">
						<div class="d-md-block mg-b-30">
							<div class="form-group mg-b-0">
								<label>Date Of Recording: <span class="tx-danger">*</span></label>
								<input class="form-control wd-200 wd-sm-400" type="date" name="date" required="required">
							...
							<div class="form-group mg-b-0 mg-t-20 mg-md-t-0">
								<label>Add Video: <span class="tx-danger">*</span></label> <input
									type="file" name="video" class="form-control wd-200 wd-sm-400"
									></input>
							</div>
							<!-- form-group -->
						</div>
